# Unity Catalog unit (dev). Operates inside the workspace, so it needs BOTH
# Databricks providers: mws (metastore assignment) + workspace (catalog/grants).
# workspace_id/url come from the workspace layer via a dependency block.
